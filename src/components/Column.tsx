...
const column = (props : any) => {
  ...
  return (
    <div className='h-auto'>
        ...
        <div className='mt-3 md:flex-col items-center flex md:h-auto md:min-h-[75%] md:w-43 h-41 bg-gray-600 rounded-2xl' onDrop={(e) => onDrop(e, status)} onDragOver={onDragOver} >
